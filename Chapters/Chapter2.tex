...
=======
Data $m$, random $r_a$ & & random $r_b$ \\[-4mm]
$(c_A,d_A)\rightarrow commit(0,m_A,r_a)$ & $(c_A)$ & \\[- 4mm]
							 & $(r_b)$ & \\[- 4mm]	
						  & $d_A$ & $(0,m',r'_a) \leftarrow Open(c'_A,d'_A)$ \\[-4mm]
$SAS_A \leftarrow r'_b\oplus h_{r_a}(m')$ & $SAS_A$ & \\ [-4mm]
								& $SAS_B$ & $SAS_B \leftarrow r_b\oplus h_{r'_A}(m)$ \\ [-4mm]
check $SAS'_B = SAS_A$ 					 & & if $SAS'_A = SAS_B$ \\ [-4mm]
...
=======
random $r_a$, data $m_A$ & & random $r_b$, data $m_B$ \\[-4mm]
$(c_A,d_A)\rightarrow commit(r_a)$ & $(m_A,c_A)$ & \\[- 4mm]
						 & $(m_B,r_b)$ & \\[- 4mm]
						 & $d_A$ & $r'_a \leftarrow Open(c'_A,d'_A)$ \\[-4mm]
$oob_A = h(r_a,r'_b,m_A,m'_B)$ & & $oob_B = h(r'_a,r_b,m'_A,m_B)$\\ [-4mm]
							&$oob_A$& \\ [-4mm]
 							& & $?oob_A = oob_B$ \\ [-4mm]
accept $(m_A,m'_B)$ & & accept $(m'_A,m_B)$ \\ [-4mm]
>>>>>>> 3d6cc25ad869467a057daa522b35e3cad82b4604
...
=======
random $g^a$		 & & random $g^b$ \\[-4mm]
$(c,d) \leftarrow commit(g^a)$ &$(ID_A,c)$ & \\[- 4mm]
						& $(ID_B,g^b)$ & \\[- 4mm]
						& $d$ & $g'^a \leftarrow Open(c',d')$ \\[-4mm]
$sid=(ID_A,ID'_B)$			& & $sid=(ID'_A,ID_B)$	\\[-4mm]
$oob_a =h(sid,g^a,g'^b)$ & & $oob_b =h(sid,g'^a,g^b)$\\[-4mm]
					 & $oob_a$& \\ [-4mm]
 					 & & $?oob_a = oob_b$\\ [-4mm]
 accepts $key =(g^a)^b = (g'^b)^a$ & & accepts $key =(g'^a)^b = (g^b)^a$ \\ [-4mm] 
>>>>>>> 3d6cc25ad869467a057daa522b35e3cad82b4604
