...
\vspace{0.6cm}
{\Large {\bf Spécialité \og Computer Science \fg}}\\
%
%
%
\vspace{.8cm}
...
\noindent
{\LARGE {\bf Toward Secure Wireless Protocols in The Context of Internet of Things}}\\
}
%
%
%
...
{\normalsize
\begin{tabular}{c}
Directeur de thèse:					{\bf Jean LENEUTRE}\\
\end{tabular}
}
\end{center}
%
...
{\bf M. Christophe BIDAN}, {\small Professor, Supelec Rennes}
	\hfill Reviewer\\
{\bf M. Abdelmajid BOUABDALLAH}, {\small Professor, UTC Compiegne}
	\hfill Reviewer\\
{\bf M. Patrick BELLOT}, {\small Professor, Telecom ParisTech}
	\hfill Examiner\\
{\bf M. Nguyen Dinh THUC}, {\small Associate Professor, University of Science, HCMC}
	\hfill Examiner\\
{\bf Mme. Maryline LAURENT}, {\small Professor, Telecom SudParis}
	\hfill Examiner\\
\end{minipage}\\
%
%
